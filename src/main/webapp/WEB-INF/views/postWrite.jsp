            ...
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" action="postWrite.ing">
                    <div class="form-group">
                      <label for="usid">작성자 ID</label>
                      <input type="text" class="form-control" name="userId" id="usid" value="${userData.getUserId()}" readonly>
                    </div>
                    <div class="form-group">
                      <label for="title">공지 제목</label>
                      <input type="text" class="form-control" name="postTitle" id="title" placeholder="Title">
                    </div>
                    <div class="form-group">
                      <label for="contents">공지 본문</label>
                      <textarea class="form-control" name="postContents"id="contents" rows="4" placeholder="내용을 입력하세요"></textarea>
                    </div>
                    <button type="submit" class="btn btn-primary mr-2">공지하기</button>
