				...
				<div class="content-wrapper">
					...
					<div class="row">
						...
						<div class="col-md-12 stretch-card">
							<div class="card">
								<div class="card-body">
									<p class="card-title">선호 채널 [그룹 - ${userData.getFavorTagGroup()}][관련도순]</p>
									...
									<div class="table-responsive">
												...
												<div class="card">
												<div class="card-body">
												<p class="card-title"><a href="#" onclick="javascript:window.open('https://www.youtube.com/results?search_query=${list.channelName}');" >${list.channelName}</a> <i class="mdi mdi-account-circle"></i>
												<b class="card-description">관련도[${list.relevance}]</b></p>
												<div class="table-responsive">
														<p>${list.channelExp}</p>
												</div>
												...
												<tr>
												<td>
												<button class="btn btn-danger btn-rounded btn-sm" onclick="javascript:location.href='channelLike_my.ing?channelId=${list.channelId}&like_whether=1'">
												<i class="mdi mdi-heart"></i>${list.likeCnt}
														</button>
												</td>
												<td>
												<button class="btn btn-secondary btn-rounded btn-sm" onclick="javascript:location.href='channelLike_my.ing?channelId=${list.channelId}&like_whether=0'">
										...
										<div class="btn-group" role="group"
															...
															<button type="button" class="btn btn-primary btn-sm" onclick="javascript:location.href='channel_my.do?pageNum=1';"><i class="mdi mdi-page-first"></i></button>
															<button type="button" class="btn btn-primary btn-sm" onclick="javascript:location.href='channel_my.do?pageNum=${listPageNum-1}';"><i class="mdi mdi-chevron-left"></i></button>
															</c:if>
															<c:forEach items="${listPageNumList}" var="page">
																<button type="button" class="btn btn-outline-primary btn-sm" onclick="javascript:location.href='channel_my.do?pageNum=${page}';">
																	<c:choose>
															...
															<button type="button" class="btn btn-primary btn-sm" onclick="javascript:location.href='channel_my.do?pageNum=${listPageNum+1}';"><i class="mdi mdi-chevron-right"></i></button>
															<button type="button" class="btn btn-primary btn-sm" onclick="javascript:location.href='channel_my.do?pageNum=${listPageNumList_lastNum}';"><i class="mdi mdi-page-last"></i></button>
															</c:if>
										</div>
										</td>
										</tr>
