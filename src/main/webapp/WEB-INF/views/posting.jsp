								...
								<div class="card-body">
									...
									<div class="table-responsive">
										...
										<div class="btn-group" role="group"
															...
															<button type="button" class="btn btn-primary btn-sm" onclick="javascript:location.href='posting.do?pageNum=1';"><i class="mdi mdi-page-first"></i></button>
															<button type="button" class="btn btn-primary btn-sm" onclick="javascript:location.href='posting.do?pageNum=${listPageNum-1}';"><i class="mdi mdi-chevron-left"></i></button>
															</c:if>
															<c:forEach items="${listPageNumList}" var="page">
																<button type="button" class="btn btn-outline-primary btn-sm" onclick="javascript:location.href='posting.do?pageNum=${page}';">
																	<c:choose>
															...
															<button type="button" class="btn btn-primary btn-sm" onclick="javascript:location.href='posting.do?pageNum=${listPageNum+1}';"><i class="mdi mdi-chevron-right"></i></button>
															<button type="button" class="btn btn-primary btn-sm" onclick="javascript:location.href='posting.do?pageNum=${listPageNumList_lastNum}';"><i class="mdi mdi-page-last"></i></button>
															</c:if>
										</div>
										</td>
										<td>
										<button type="button" class="btn btn-outline-primary btn-icon-text" onclick="javascript:location.href='postWrite.do'"><i class="mdi mdi-tooltip-outline-plus btn-icon-prepend"></i>글쓰기</button>
